...
public class OldMandelbrotAnimation {
    ...
    public static void main(String[] args) {
        ...
        double lastScale = 0.01;
        double lastTranslateX = -0.768;
        double lastTranslateY = 0.09984;
        ...
        try {
            ...
            try {
                out = new AVIWriter(new File("mandelbrot-old.avi"));
                out.addTrack(format);
